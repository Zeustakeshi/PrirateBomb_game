package Entity.Player.BigGuy;

import ColliderBox.ColliderBox;
import ColliderBox.RectangleColliderBox;
import Entity.Player.BigGuy.States.*;
...
public class BigGuy extends Player {
    ...
    private final ColliderBox<RectangleColliderBox> attackBox;

    public BigGuy(Socket socket, BombManager bombManager, String id, String roomId) {
        super(socket, bombManager, Types.BIG_GUY, id, roomId);
    ...
    public void update() {
        ...
        this.attackBox.update(
                ...
                this.hitBox.y + this.hitBox.height * 0.5 - ATTACK_HEIGHT * 0.5,
                ATTACK_WIDTH,
                ATTACK_HEIGHT
        );
    }
